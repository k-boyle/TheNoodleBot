...
public class ArgumentParserTests {
    ...
    public void argumentParserTest(Command command, String[] arguments, ArgumentParserResult expectedResult) {
        ...
        // todo fix context
        ArgumentParserResult actualResult = argumentParser.parse(null, command, arguments);
        Assertions.assertEquals(expectedResult, actualResult);
    }

    public static class BadParser implements TypeParser<Long> {
        @Override
        public TypeParserResult<Long> parse(CommandContext context, Command command, String input) {
